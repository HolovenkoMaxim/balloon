 ...
 */
    ...
    (() => {
        ...
        let dataPickers = document.querySelectorAll("[data-datepicker]");
        if (dataPickers) dataPickers.forEach((function(item, i) {
            const picker = datepicker_min(item, {
        ...
        const inputMasksPhone = document.querySelectorAll(".form-question__phone");
        if (inputMasks.length) modules_flsModules.inputmask = Inputmask().mask(inputMasks);
        if (inputMasksPhone.length) modules_flsModules.inputmask = Inputmask("+38(9{1,3})9{1,3}-9{1,2}-9{1,2}").mask(inputMasksPhone);
        ...
        function rangeInit() {
            ...
            if (priceSlider) {
                ...
                priceSlider.noUiSlider.on("update", (function(values, handle) {
                    ...
                    if (0 === handle) priceStart.value = Math.round(value); else priceEnd.value = Math.round(value);
                }));
            }
        }
        rangeInit();
        ...
        function initSliders() {
            if (document.querySelector(".welcome__slider-big")) var BigSwiper = new core(".welcome__slider-big", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".slider-welcome-small")) new core(".slider-welcome-small", {
            ...
            if (document.querySelector(".slider-excursions")) new core(".slider-excursions", {
                ...
                navigation: {
                    prevEl: ".excursions__arrow-left",
                    nextEl: ".excursions__arrow-right"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".slider-routes")) new core(".slider-routes", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.2,
                ...
                navigation: {
                    prevEl: ".routes__arrow-left",
                    nextEl: ".routes__arrow-right"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 1.1,
        ...
        class FullPage {
            ...
            wheel(e) {
                ...
                const activeSectionSlide = document.querySelector(".active-section");
                if (activeSectionSlide) adaptiveHeader(activeSectionSlide);
            }
        ...
        function adaptiveHeader(element) {
            if (element) {
                let datasetFpId = element.dataset.fpId;
                const headerElement = document.querySelector("header.header");
                if (0 != datasetFpId) headerElement.classList.add("_header-scroll"); else headerElement.classList.remove("_header-scroll");
            }
        }
...
***************************************************************************** */
        ...
        document.querySelector(".gallery__see");
        if (galleries.length) {
            let galleyItems = [];
